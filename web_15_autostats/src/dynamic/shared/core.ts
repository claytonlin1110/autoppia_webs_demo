 ...
 *   dyn.v2.isEnabled()            // V2: Check if load-from-server is enabled
...
export function useDynamicSystem() {
  ...
  return useMemo(() => ({
    ...
    v1: {
       ...
       *
       * @param componentKey - Unique component identifier (e.g. "search-button", "header-nav")
       ...
       * @param key - Unique identifier (e.g. "stats-cards", "header-nav-links")
       * @param count - Number of elements (e.g. 4, 5, 10)
